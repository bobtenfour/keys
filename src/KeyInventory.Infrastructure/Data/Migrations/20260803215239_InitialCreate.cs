    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TypeCode = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CatalogKeyCode = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    KeyTypeCode = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoanCode = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    CatalogKeyCode = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    BorrowerPartyReference = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReturnCode = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    LoanCode = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ReturnedAtUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
