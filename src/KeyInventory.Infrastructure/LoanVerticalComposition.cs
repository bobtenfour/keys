...
public static class LoanVerticalComposition
{
    public static void AddLoanVertical(IServiceCollection services, string connectionString)
    {
        ...
        services.AddScoped<IKeyAccessResolutionPort, KeyAccessResolutionAdapter>();
        ...
        services.AddScoped<IMarkKeyAssetLostUseCase, MarkKeyAssetLostUseCase>();
        services.AddScoped<IDestroyKeyAssetUseCase, DestroyKeyAssetUseCase>();
        services.AddScoped<IReplaceLostKeyUseCase, ReplaceLostKeyUseCase>();
        services.AddScoped<ISearchLostKeysUseCase, SearchLostKeysUseCase>();
        ...
        services.AddScoped<ISearchIssuablePhysicalCopiesUseCase, SearchIssuablePhysicalCopiesUseCase>();
        services.AddScoped<ISearchOpenCustodyUseCase, SearchOpenCustodyUseCase>();
        ...
        services.AddScoped<IGlobalOperatorSearchPort, GlobalOperatorSearchAdapter>();
        services.AddScoped<IGlobalOperatorSearchUseCase, GlobalOperatorSearchUseCase>();
